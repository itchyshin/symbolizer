...
- `symbolize.gllvmTMB()` for Gaussian latent variables with mu,
...
2. **Automated syndromes reading.**
   ...
   one row per (trait, axis) pair today; v0.5+ adds the
   natural-scale reading for non-Gaussian families.
...
**Takeaway.** v0.2 ships the latent-variable Gaussian case
end-to-end; further families and uncertainty surfaces come in v0.5+.
