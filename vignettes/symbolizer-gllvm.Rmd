...
description: "Generalized linear latent-variable (GLLVM) models for multivariate ecology: factors, loadings, and the implied trait covariance."
...
> produces, and see how `symbolize()` renders the latent structure.*
...
Dochtermann 2013). gllvmTMB's `extract_correlations(fit)` returns
