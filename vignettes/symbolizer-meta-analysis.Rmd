...
description: "The same meta-analytic model across metafor, glmmTMB, and drmTMB -- known sampling variances and the heterogeneity they leave behind."
...
> how `symbolize()` renders the three common flavors — random-effects,
> phylogenetic, and location-scale — side by side across the packages.*
