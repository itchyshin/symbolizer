...
Tabs 1 and 2 carry the index- and matrix-form equations and the
variance-component panel showing the two estimated tiers
($\sigma_{\text{study}}^2$ and $\sigma_p^2\,\mathbf{A}$) alongside the
known sampling tier $v_{kt}$. (The "with your numbers" tab falls back to
