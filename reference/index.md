...
Demystify treatment / contrast coding for multi-level factors and
interactions — in one call, or an interactive widget.
...
predictors, groups, random effects). Returns a list with DOT (GraphViz),
Mermaid (Markdown / Quarto), and TikZ (LaTeX) representations.
...
Pseudocode + runnable R code describing how to simulate from a fitted
model.
