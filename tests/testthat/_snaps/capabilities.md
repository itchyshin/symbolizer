# capability_check() rejects drmTMB/gaussian/zi (Planned)
    ...
    Condition
      ...
      * brms gaussian: meta_known_vi (First slice)
      ...
      * drmTMB gaussian: meta_known_vi, meta_phylo_multilevel, phylo, random_effects (First slice)
      ...
      * gam binomial: mu, smooth (First slice)
      * gam Gamma: mu, smooth (First slice)
      * gam gaussian: mu, smooth (First slice)
      * gam poisson: mu, smooth (First slice)
      * gllvmTMB *: Lambda_W, phylo, Psi_W (First slice)
      * gllvmTMB binomial: Lambda_B, mu, Psi_B, Sigma_B (First slice)
      * gllvmTMB gaussian: Lambda_B, mu, Psi_B, Repeatability, Sigma_B, sigma_eps, Sigma_W (First slice)
      * gllvmTMB poisson: Lambda_B, mu, Psi_B, Sigma_B (First slice)
      ...
      * metafor *: meta_phylo_multilevel, phylo (First slice)
      * phylolm *: phylo (First slice)
      * phylolm gaussian: mu (First slice)
