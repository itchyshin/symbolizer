...
[Skip three-views widget](#sym-sym-1779636084-end)

    <button type="button" class="sym-tab sym-active" role="tab" id="sym-sym-1779636084-tab-eq" aria-controls="sym-sym-1779636084-panel-eq" aria-selected="true" tabindex="0" data-tab="eq"><span class="sym-tab-marker" aria-hidden="true">&#9656;</span>1. Equation</button>
    <button type="button" class="sym-tab" role="tab" id="sym-sym-1779636084-tab-idx" aria-controls="sym-sym-1779636084-panel-idx" aria-selected="false" tabindex="-1" data-tab="idx"><span class="sym-tab-marker" aria-hidden="true">&#9656;</span>2. Index</button>
    <button type="button" class="sym-tab" role="tab" id="sym-sym-1779636084-tab-mat" aria-controls="sym-sym-1779636084-panel-mat" aria-selected="false" tabindex="-1" data-tab="mat"><span class="sym-tab-marker" aria-hidden="true">&#9656;</span>3. Matrix (with data)</button>
