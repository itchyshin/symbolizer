...
If a `.memory/` directory exists, read `.memory/MEMORY.md` before
starting non-trivial work. Otherwise, treat the design plan referenced
in issues or PR descriptions as the source of truth.
...
- The term-grammar bridge (`R/extract-terms.R`) is the prerequisite for
  ...
  contrasts, two-way interactions, offsets,
  [`scale()`](https://rdrr.io/r/base/scale.html)/[`log()`](https://rdrr.io/r/base/Log.html)/[`I()`](https://rdrr.io/r/base/AsIs.html)
  transforms, random-effect groupings.
- The capability registry (`inst/extdata/capabilities.csv`) gates
  [`symbolize()`](https://itchyshin.github.io/symbolizer/reference/symbolize.md).
  New `(class, family, component)` tuples must have a row with one of:
  Stable / First slice / Opt-in control / Planned or reserved /
