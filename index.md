...
Where [`equatiomatic`](https://datalorax.github.io/equatiomatic/)
returns a LaTeX string, `symbolizer` returns a *structured symbolic
model* from which you can render the equation, list the assumptions,
bridge R syntax to mathematics, interpret each coefficient on its
natural scale, and (in later versions) compare two models structurally
and explain what the comparison means biologically.

Built first for the two TMB sister packages —
[`drmTMB`](https://itchyshin.github.io/drmTMB/) and
[`gllvmTMB`](https://itchyshin.github.io/gllvmTMB/) — then extended
across the full GLMM ecosystem used in ecology and evolution: `glmmTMB`,
